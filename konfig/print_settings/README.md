...
A hidakra vonatkozó áramlási arány beállításához lásd a [Áramlási arány hidakhoz](./#aramlasi-arany) paramétert.
...
{% page-ref page="kitoeltesi-mintak.md" %}
...
Ha az [_**XY méretkompenzáció**_ \(Elefántláb-kompenzáció\)](./#szeleteles) aktiválva van, az előnézetben egy kis tér jelenik meg a modell és a keret között.
...
Felhívjuk a figyelmet arra, hogy a tisztítótorony aktiválása nem lehetséges a **Az objektumok nyomtatása egyesével** módban \([ **Nyomtatási beállítások - Kimeneti beállítások - Sorrendben történő nyomtatás**](./#sorrendben-szekvencialis-toerteno-nyomtatas) menüben\).
