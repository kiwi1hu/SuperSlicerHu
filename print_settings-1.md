...
A hidakra vonatkozó áramlási arány beállításához lásd a [Áramlási arány hidakhoz](print_settings-1.md#aramlasi-arany) paramétert.
...
Ha az [_**XY méretkompenzáció**_ \(Elefántláb-kompenzáció\)](print_settings-1.md#szeleteles) aktiválva van, az előnézetben egy kis tér jelenik meg a modell és a keret között.
...
Felhívjuk a figyelmet arra, hogy a tisztítótorony aktiválása nem lehetséges a **Az objektumok nyomtatása egyesével** módban \([ **Nyomtatási beállítások - Kimeneti beállítások - Sorrendben történő nyomtatás**](print_settings-1.md#sorrendben-szekvencialis-toerteno-nyomtatas) menüben\).
